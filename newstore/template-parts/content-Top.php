                                        ...
                                        <?php while ($vnkings->have_posts()) : $vnkings->the_post(); ?>
                                            ...
                                            <li>
                                                <figure>
                                                    ...
                                                    <a class="aa-add-card-btn"href=""><span class="fa fa-shopping-cart">Mua Nay</span><?php ?>
                                                    </a>
                                                    <figcaption>
                                                        <h4 class="aa-product-title"><a href="http://wordpress.local/DAWP/sản phẩm/<?php the_title() ?>""> <?php the_title() ;?></a></h4>
                                                        <span class="aa-product-price"><?php $price=get_post_meta(get_the_ID(),"price",true) ?>></span><span class="aa-product-price"><del>$65.50</del></span>
                                                    </figcaption>
                                                </figure>
                                                <div class="aa-product-hvr-content">
                                                    <a href="#" data-toggle="tooltip" data-placement="top" title="Add to Wishlist"><span class="fa fa-heart-o"></span></a>
                                                    <a href="#" data-toggle="tooltip" data-placement="top" title="Compare"><span class="fa fa-exchange"></span></a>
                                                    <a href="http://wordpress.local/DAWP/single/"><span class="fa fa-search">View</span></a>
                                                </div>
                                                <!-- product badge -->
                                                <span class="aa-badge aa-sale" href="#">SALE!</span>
                                            </li>
                                            <!-- Sản phẩm --><?php endwhile ; wp_reset_query() ; ?>
